  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="nav">
        ...
        {onLogout && (
          <button className="navBtn" onClick={onLogout} style={{ marginTop: "auto" }}>
            <svg viewBox="0 0 24 24" fill="none"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4M16 17l5-5-5-5M21 12H9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
                Sign Out
              </div>
