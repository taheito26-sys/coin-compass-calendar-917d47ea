    ...
    <div className="break-even-widget">
      <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
        {underwater.map(asset => (
          <div key={asset.sym} style={{ background: "rgba(255,255,255,0.03)", border: "1px solid var(--line)", padding: 6, borderRadius: 8 }}>
            ...
            <div style={{ marginTop: 6, height: 4, background: "var(--line)", borderRadius: 2, overflow: "hidden", position: "relative" }}>
